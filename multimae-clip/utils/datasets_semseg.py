...
def build_semseg_dataset(args, data_path, transform, caption_path="", max_images=None):
    ...
    return MultiTaskImageFolder(data_path, args.all_domains, caption_path=caption_path, transform=transform, prefixes=prefixes, max_images=max_images)
